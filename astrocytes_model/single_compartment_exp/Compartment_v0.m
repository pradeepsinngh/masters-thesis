...
kCa = 250;  % units uM.s^-1 (multiplies effective open-channel fraction)
...
PIP20 = 30; % available PIP2 concentration
...
for t = 0:dt:tend % loop on time
    ...
    % InP3 update
    %InP3 = InP3 + kd1f*(PIP20-InP3).*Ca./(1+ki2*PKCv) - k1b*InP3;
    % version with G-protein input
    InP3 = InP3 + (PIP20-InP3).*(Gin + kd1f*Ca) - k1b*InP3;
